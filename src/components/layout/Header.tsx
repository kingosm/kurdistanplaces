        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 md:gap-4 group">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg md:text-3xl font-black tracking-tighter transition-colors group-hover:text-primary leading-none whitespace-nowrap">
                <span className="bg-gradient-to-b from-[#EF3340] via-white to-[#007A3D] bg-clip-text text-transparent drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">KURDISTAN</span>

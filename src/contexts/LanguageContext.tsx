...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'header.logo.main': 'KURDISTAN',
        'header.logo.accent': 'PLACES',
    ...
    ku: {
        ...
        'header.logo.main': 'کوردستان',
        'header.logo.accent': 'شوێنەکان',
    ...
    ar: {
        ...
        'header.logo.main': 'كردستان',
        'header.logo.accent': 'أماكن',
